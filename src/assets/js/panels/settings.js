...
class Settings {
  ...
  async javaPath() {
    ...
    let configClient = await this.db.readData("configClient");
    let javaPath = configClient?.java_config?.java_path || "Use a versão Java fornecida com o inicializador";
    ...
    document.querySelector(".java-path-reset").addEventListener("click", async () => {
      let configClient = await this.db.readData("configClient");
      javaPathInputTxt.value = "Use a versão Java fornecida com o inicializador";
